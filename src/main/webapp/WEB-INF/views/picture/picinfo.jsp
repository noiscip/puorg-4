...
<div class="page-header header-filter" data-parallax="true" filter-color="rose" style="background-image: url('<%=request.getContextPath()%>/assets/img/bg7.jpg');">
        <div class="container">
            ...
            <div class="main main-raised main-product">
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        ...
                        <div class="nbs-flexisel-container"><div class="nbs-flexisel-inner"><ul class="nav flexi-nav nbs-flexisel-ul" data-tabs="tabs" id="flexiselDemo1" style="left: -750px;"><li class="nav-item nbs-flexisel-item" style="width: 125px;">
                                <a href="#product-page1" class="nav-link" data-toggle="tab">
                                    <img src="../assets/img/examples/product1.jpg">
                                </a>
                            </li><li class="nav-item nbs-flexisel-item" style="width: 125px;">
